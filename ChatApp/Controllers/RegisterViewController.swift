...
class RegisterViewController: UIViewController {
    ...
    @objc private func didTapChangeProfilePicture() {
        print("Change profile Picture is tapped")
    }
    ...
    private func alertUserRegisterError() {
        let alert = UIAlertController(title: "Woops", message: "Plesase enter all information to create a new account", preferredStyle: .alert)
